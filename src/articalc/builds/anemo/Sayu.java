...
public class Sayu extends CharacterBuilds {

	@Override
	public void assignBuilds(ArrayList<Build> cb) {
		cb.add(new SupportBall(character, 1f));
	}

}

class SupportBall extends Build {

	public SupportBall(Characters character, float priority) {
