...
public class Qiqi extends CharacterBuilds {
...
class BallofDoom extends Build {

	public BallofDoom(Characters character, float priority) {
...
class WastedPotentialHealer extends Build {

	public WastedPotentialHealer(Characters character, float priority) {
		super(character, priority);
	}
