...
public class Xingqui extends CharacterBuilds {

	@Override
	public void assignBuilds(ArrayList<Build> cb) {
		cb.add(new WaterBoiThings(character, 1f));
	}

}

class WaterBoiThings extends Build {

	public WaterBoiThings(Characters character, float priority) {
