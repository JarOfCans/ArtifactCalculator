...
public class Mona extends CharacterBuilds {

	@Override
	public void assignBuilds(ArrayList<Build> cb) {
		cb.add(new MonaBeef(character, 1f));
	}

}

class MonaBeef extends Build {

	public MonaBeef(Characters character, float priority) {
