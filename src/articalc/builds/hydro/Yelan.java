...
public class Yelan extends CharacterBuilds {

	@Override
	public void assignBuilds(ArrayList<Build> cb) {
		cb.add(new DiceTaim(character, 1f));
	}

}

class DiceTaim extends Build {

	public DiceTaim(Characters character, float priority) {
