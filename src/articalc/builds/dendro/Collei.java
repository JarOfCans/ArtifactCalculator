...
public class Collei extends CharacterBuilds {

	@Override
	public void assignBuilds(ArrayList<Build> cb) {
		cb.add(new DaBabiSupport(character, 0.75f));
		cb.add(new DaBabiGilded(character, 0.25f));
	}

}


class DaBabiSupport extends Build {

	public DaBabiSupport(Characters character, float priority) {
...
class DaBabiGilded extends Build {

	public DaBabiGilded(Characters character, float priority) {
		super(character, priority);
	}
