...
public class Alhaitham extends CharacterBuilds {

	@Override
	public void assignBuilds(ArrayList<Build> cb) {
		cb.add(new ScribeThings(character, 1f));
	}

}

class ScribeThings extends Build {

	public ScribeThings(Characters character, float priority) {
